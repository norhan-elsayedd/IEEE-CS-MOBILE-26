        ...
        appBar: AppBar(
          ...
          title: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                 Text("Task 7",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,),),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      children: [
                        Icon(Icons.person,color: Colors.deepPurple,size: 60,weight:100 , )
                      ],
                    ),
                    Padding(padding: EdgeInsets.all(10),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Norhan Elsayed Atia", style: TextStyle(fontSize: 20,fontWeight: FontWeight.w900,color: Colors.black,),),
                          Text("Flutter Developer",style: TextStyle(fontSize: 15,color:Colors.deepPurple ),),
                        ],
                      ),
                    )
                  ],
               ...
               Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Icon(Icons.share,size: 25,color: Colors.deepPurple,fontWeight: FontWeight.bold,)
                  ],
                ),
              ),
               ...
               Container(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      children: [
                        Icon(Icons.code, color: Colors.deepPurple,fontWeight:FontWeight.bold , size: 25,),
                    ...
                    Column(
                      children: [
                        Icon(Icons.bug_report_sharp,color: Colors.deepPurple,fontWeight:FontWeight.bold , size: 25,),
                    ...
                    Column(
                      children: [
                        Icon(Icons.coffee,color: Colors.deepPurple,fontWeight:FontWeight.bold , size: 25,),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Icon(Icons.gps_fixed,color: Colors.red,size: 18,),
                        Container(width: 8), 
                        Text("My Hobbies:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black,)),
                      ],
                    ),
                    Container(height: 5,),
